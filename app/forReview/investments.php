	public function investments()
	{
		if(Auth::user()->rule_id != 4){
	        ...
	        return View::make('profile.common.investments')->with('companies', $companies)
	        											   ->with('asset_class', $asset_class)
	        											   ->with('topmenu', 'investments');
	    }else{
