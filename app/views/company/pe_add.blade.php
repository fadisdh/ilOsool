...
@section('content')
    <div class="profile">
        ...
        <div class="container">
            @if ($company->id == 0)
                <div class="page-title">{{trans('deal.add_new_listing_type')}} {{trans('deal.private_equity')}}</div>
            @else 
                    ...
                    <div class="profile-stepper">
                        ...
                        <div id="stepper" class="stepper">
                            <div class="stepper-wrapper">
                                {{ Form::model($company, array('route' => array('company.pe.add.post', $company->id),
                                'files' => true,
                                'class' => 'form-horizontal')) }}
                                    ...
                                    <div class="stepper-item">
                                        @include('company.form.pe_investment')
                                    </div>
                                {{ Form::token(); }}
                                {{ Form::close() }}
                            </div>
