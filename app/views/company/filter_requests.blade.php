<div class="filter-sidemenu">
	<div class="filter-box list-unstyled">
		<div class="hline"></div>
		<h3>Search Requested Deals</h3>
		<div class="search-investments">
			{{ Form::open(array('route' => 'requested.deals', 'method' => 'get')) }}
				<div class="input-group">
		            {{ Form::text('search_requests', Input::get('search_requests'), array('class' => 'form-control search animation', 'placeholder' => 'Search Here ...')) }}
	...
	<div class="filter-box list-unstyled">
		<a href="{{ URL::current() }}" title="Clear search data" class="filter-btn clear-filter col-md-12">Clear Filters</a>
	</div>
	{{ Form::close() }}
</div>
