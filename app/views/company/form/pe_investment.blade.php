...
<div class="form-group {{ $errors->first('sector') ? 'has-error' : '' }}">
    ...
    <div class="col-md-7">
        {{ getSelect('pe_sector_interests', 'sector') }}
    </div>
    <div class="col-md-7 col-md-offset-3">
...
<div class="form-group {{ $errors->first('investment_stage') ? 'has-error' : '' }}">
    ...
    <div class="col-md-7">
        {{ getSelect('pe_investment_stage', 'investment_stage') }}
    </div>
...
<div class="form-group {{ $errors->first('deal_size') ? 'has-error' : '' }}">
    ...
    <div class="col-md-7">
        {{ getSelect('pe_deal_size', 'deal_size') }}
    </div>
    <div class="col-md-7 col-md-offset-3">
...
<div class="form-group {{ $errors->first('price_earning') ? 'has-error' : '' }}">
    <label for="price_earning" class="control-label col-md-2 col-md-offset-1">{{trans('deal.price_earning')}} <a id="popover-right" class="hint popover-right" data-container="body" data-toggle="popover" data-placement="right" data-content="{{trans('deal.hints.price_earning')}}">[?]</a></label> 
    <div class="input-group col-md-7">
