    ...
    <div class="container">
        <div class="page-container registration-page">
            ...
            <div class="register-type row">
                <a href="{{ URL::route('register.investor') }}" class="col-md-4">Register as an Investor</a>
                <a href="{{ URL::route('register.company') }}" class="col-md-4">Register as Lister</a>
                <a href="{{ URL::route('register.both') }}" class="col-md-4 selected">Register as Investor & Lister</a>
            </div>
            <div class="page-content">
                <h2 class="page-title">Register as Investor & Lister</h2>
                {{ Form::model($user, array('route' => 'register.both.post', 'class' => 'form-horizontal')) }}
