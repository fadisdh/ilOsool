                                                    ...
                                                    <tbody><tr>
                                                        <td valign="top" style="border-collapse: collapse;">
                                                            <div style="color: #505050;font-family: Arial;font-size: 14px;line-height: 140%;text-align: justify;">
                                                            	<b>Hello,</b>
                                                                <br><br>
                                                                Thank you for registering with ilOsool. If you have any questions about the operation of ilOsool system, please contact us.
                                                            </div>
                                                            <br>
                                                            <center>
                                                            <table border="0" cellpadding="0" cellspacing="0" class="emailButton" style="border-radius:3px; background-color:#1C344D;">
															    <tr>
															        <td align="center" valign="middle" class="emailButtonContent" style="padding-top:15px; padding-right:30px; padding-bottom:15px; padding-left:30px;">
															            <a href="{{ URL::route('home') }}" target="_blank" style="color:#FFFFFF; font-family:Helvetica, Arial, sans-serif; font-size:16px; font-weight:bold; text-decoration:none;">Start using ilOsool</a>
															        </td>
															    </tr>
															</table>
															</center>
