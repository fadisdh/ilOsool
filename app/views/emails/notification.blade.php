...
<html><head>
        ...
        <meta property="og:title" content="ilOsool Notification">
        
        <title>ilOsool Notification</title>
    ...
    <body leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0" style="-webkit-text-size-adjust: none;margin: 0;padding: 0;background-color: #FAFAFA;width: 100% !important;">
    	<center>
        	<table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" id="backgroundTable" style="margin: 0;padding: 0;background-color: #FAFAFA;height: 100% !important;width: 100% !important;">
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" class="emailButton" style="border-radius:3px; background-color:#1C344D;">
															    <tr>
															        <td align="center" valign="middle" class="emailButtonContent" style="padding-top:15px; padding-right:30px; padding-bottom:15px; padding-left:30px;">
															            <a href="{{ $url }}" target="_blank" style="color:#FFFFFF; font-family:Helvetica, Arial, sans-serif; font-size:16px; font-weight:bold; text-decoration:none;">Open</a>
															        </td>
															    </tr>
															</table>
															</center>
                ...
                <tr>
                    <td align="center"><a href="{{URL::route('profile.info.edit')}}" class="unsubscribe" target="_blank">unsubscribe from ilOsool's mail notifications</a></td>
                </tr>
            </tbody></table>
        </center>
</body></html>